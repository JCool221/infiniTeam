...
const managerQuestions = () => {
    ...
    .then(managerData => {
        ...
        const manager = new Manager (`Hi there, I'm ${name} id#${id}, my email is ${email} office# ${office}`);
...
const team = () => {
    ...
    .then(employeeData => {
        ...
        if (addNewEmployee) {
            ...
            console.log(theTeam);
            // fs.writeFile('Main.html', generateHTML());
        }
    })
};
            ...
            <div class="col-4">
                <div class="card  mt-3" style="width: 18rem;">
                    <div class="card-header bg-info">
                        <h1 id='role' class="display-4">Test Text</h1>
                    </div>
                    <div class="card-body">
